...
| Campodoglio | verde | Microfix strutturale completato: il sito ufficiale descrive un campo fisico 9 buche Par 36 e tabelle `Buca 1/10`…`9/18` per Par72 e Par70. In UX restano attive solo `9 Buche`, `18 Buche Par 72`, `18 Buche Par 70`; varianti tecniche New/Easy/Mixed disattivate. La certificazione usa la matrice ufficiale HCP tee-specific: primo valore per il primo giro, secondo valore per il secondo giro, con differenza Bianco/Giallo vs Blu/Rosso. |
