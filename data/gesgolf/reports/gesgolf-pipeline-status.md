...
- Regola naming:
  ...
  - per route 18 ottenute giocando due volte lo stesso percorso 9, usare copy compatta `{Nome percorso} × 2` e dettaglio `18 buche · Par X`, ad esempio `Blu × 2` / `18 buche · Par 74`; evitare `9 Buche Blu 2 Volte`.
