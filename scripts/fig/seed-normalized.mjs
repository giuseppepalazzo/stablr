...
async function upsertClub(supabase, clubPayload, createdBy) {
  const basePayload = {
    ...
    data_status: clubPayload.data_status || "verified",
    source_type: clubPayload.source_type || "stablr",
    is_complex: clubPayload.is_complex ?? true,
    playable: clubPayload.playable ?? true,
